...
public sealed class MainViewModel : ViewModelBase
{
    ...
    public SecuritySettingsViewModel SecuritySettingsVM { get; }
    ...
    public LockScreenViewModel LockScreenVM { get; }
    public bool IsLocked => _appLockCoordinator.IsLocked;
    ...
    public NavigationItem? SelectedNavigationItem
    {
        ...
        set
        {
            if (SetField(ref _selectedNavigationItem, value))
            {
                ...
                else if (value?.ViewModel is SecuritySettingsViewModel)
                    _ = SecuritySettingsVM.InitializeAsync();
    ...
    public SetupWizardViewModel? SetupWizard
    {
        ...
        private set
        {
            if (!SetField(ref _setupWizard, value)) return;
            RaisePropertyChanged(nameof(CurrentPage));
            RaisePropertyChanged(nameof(IsSetupWizardVisible));
        }
    }

    public bool IsSetupWizardVisible => SetupWizard != null;

    public ViewModelBase? CurrentPage => SetupWizard ?? SelectedNavigationItem?.ViewModel;

    public Task<(string Language, string Theme)> StartSetupWizardAsync(string defaultLanguage, string defaultTheme)
    {
        SetupWizard = new SetupWizardViewModel(defaultLanguage, defaultTheme);
        return SetupWizard.Completion;
    }
    ...
    public MainViewModel(
        ...
        IAppLockCoordinator appLockCoordinator,
        ...
        ServiceProviderRepository serviceProviderRepository)
    {
        ...
        _appLockCoordinator.IsLockedChanged += (_, _) => RaisePropertyChanged(nameof(IsLocked));
        ...
        SecuritySettingsVM = new SecuritySettingsViewModel(_settingsRepository, _screenshotProtectionService, securityService, storageService, autoLockManager, idleTimeProvider, clipboardClearService, messageService);
        ...
        LockScreenVM = new LockScreenViewModel(_appLockCoordinator);
        ...
        NavigationItems = new ObservableCollection<NavigationItem>
        {
            ...
            new NavigationItem { Name = "安全设置", Icon = "M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z", ViewModel = SecuritySettingsVM },
    ...
    public async Task LoadAsync()
    {
        ...
        _ = Task.WhenAll(
            SecuritySettingsVM.InitializeAsync(),
            TimeSettingsVM.LoadSettingsAsync()
        );
    }
    ...
    private void SetLanguage(string lang)
    {
        ...
        SecuritySettingsVM.OnLanguageChanged();
    ...
    private void UpdateNavigationItems()
    {
        ...
        if (NavigationItems.Count >= 9)
        {
            ...
            NavigationItems[5].Name = GetStr("Lang.Nav.Security");
            NavigationItems[6].Name = GetStr("Lang.Nav.Backup");
            NavigationItems[7].Name = GetStr("Lang.Nav.TimeSettings");
            NavigationItems[8].Name = GetStr("Lang.Nav.About");
        }
    }
    ...
    {
        if (NavigationItems.Count > 7)
        {
            SelectedNavigationItem = NavigationItems[7]; 
        }
    }

    public void LockApp()
    {
        _ = _appLockCoordinator.LockAsync(LockReason.Manual);
    }
}
